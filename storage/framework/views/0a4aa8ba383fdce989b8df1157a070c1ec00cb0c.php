  ...
  <head>
    ...
    <style type="text/css">
        * {
        ...
        td,th {text-align: center; padding: 7px 0;width: 50%;}
        td1,th1 {text-align: center; padding: 7px 0;width: 50%;}
        table {width: 100%;}
...
<div style="max-width:400px;margin:0 auto">
    ...
    <div id="receipt-data">
        ...
        <table>
             <tbody>
                 <tr style="background-color:#ddd;"><td colspan="2">Product</td>
                  <td>QTY.</td>
                   <td>Price</td>
                    <td>Total Amt.</td>
                    </tr>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="2"><?php echo e($product_name); ?></td>
                    <td><?php echo e($product_sale_data->qty); ?></td> <td><?php echo e(number_format((float)($product_sale_data->total / $product_sale_data->qty), 2, '.', '')); ?></td>
                    <td><?php echo e(number_format((float)$product_sale_data->total, 2, '.', '')); ?></td>
                </tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <th>N.A</th>
                    <th>N.A</th>
                    <th style="text-align:Center"><?php echo e(number_format((float)$lims_sale_data->total_price, 2, '.', '')); ?></th>
                </tr>
        ...
        <table>
         ...
         <div class="centered" style="margin:30px 0 50px">
            ...
            <?php echo e(trans('file.Developed By')); ?> ECArena</strong></small>
        </div>
    </div>
</div>
